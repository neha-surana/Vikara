...
public class UserDaoJdbc implements UserDao {
    ...
    public User findUserByUserId(long userId) {
        ...
        try(Connection connection = JdbcUtils.getConnection();
            ...
            throw new VikaraQueryDbSetupException("Encountered a problem finding book with category_id: " + userId, e);
        }
    ...
    public User findUserByUserName(String userName) {
        ...
        try(Connection connection = JdbcUtils.getConnection();
            ...
            throw new VikaraQueryDbSetupException("Encountered a problem finding user with username: " + userName, e);
        }
        return user;
    }
    ...
    public void createUser(User user){
        try(Connection connection = JdbcUtils.getConnection();
            ...
            throw new VikaraQueryDbSetupException("Encountered a problem adding a user " + user.getUsername(), e);
        }
    }
