...
public class SurveyDaoJdbc implements SurveyDao {
    ...
    public Survey findBySurveyId(long surveyid) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new VikaraQueryDbSetupException("Encountered a problem finding category " + surveyid, e);
        }
        return survey;
    }
    ...
    public void createSurvey(Survey survey) {
        try(Connection connection = JdbcUtils.getConnection();
            ...
            throw new VikaraQueryDbSetupException("Encountered a problem adding a survey ");
        }
    }
